...
const MegaSheetTwo = () => {
  ...
  return (
    <div>
      ...
      <Button onClick={(e) => {
        e.preventDefault();
        navigate("/dashboard/megasheet1")
      }} style={{ marginBottom: 10, marginLeft: 10, backgroundColor: 'blue', color: 'white' }}>Previous</Button>
      <Button style={{ marginBottom: 10, marginLeft: 10, backgroundColor: 'blue', color: 'white' }}>Save</Button>
    </div>
  );
};
